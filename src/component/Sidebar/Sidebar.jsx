...
//   console.log('plan?.days_remaining:', plan?.days_remaining);
//   console.log('typeof plan?.days_remaining:', typeof plan?.days_remaining);
...
//   console.log('  totalTrialDays:', totalTrialDays);
//   console.log('  daysCompleted:', daysCompleted);
//   console.log('  progressPercentage:', progressPercentage);
//   console.log('  Will show trial card?', isTrial);
//   console.log('---\n');
...
//         {/* DEBUG: Show what cards will render */}
//         {console.log('🎨 RENDERING CARDS:', { isFree, isTrial, isPro })}
